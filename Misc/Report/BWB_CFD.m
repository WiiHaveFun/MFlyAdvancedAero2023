...
% -5 to 15 deg
polar_CFD = readtable("/Users/michaelchen/Documents/M-Fly/2023/CFD/Polars/CFD Polars for MX-9 and QM-3 - BWB_10prism.csv");
...
%     "/Users/michaelchen/Documents/M-Fly/2023/MX-9/PA_Trade3/MX-9C.avl", ...
%     "/Users/michaelchen/Documents/M-Fly/2023/MX-9/PA_Trade3/9C-Polar", ...
%     [""], ...
%     -5, ...
%     15, ...
%     NaN);
...
[alpha_AVL, CL_AVL, CD_AVL, e_AVL] = readPolarAndEFromFile( ...
    "/Users/michaelchen/Documents/M-Fly/2023/MX-9/PA_Trade3/9C-Polar/data.ft");
...
writetable(T, 'BWB_drag_polar_scaled.csv');

output = round([alpha_CFD, CL_CFD, CDp_CFD_scaled], 4);
T = array2table(output);
T.Properties.VariableNames = ["alpha", "CL", "CDp"];
writetable(T, 'BWB_parasitic_drag_polar_scaled.csv');
